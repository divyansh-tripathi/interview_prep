...
export function DottedSurface({ className, ...props }) {
    ...
    useEffect(() => {
        ...
        for (let ix = 0; ix < AMOUNTX; ix++) {
            for (let iy = 0; iy < AMOUNTY; iy++) {
                ...
                if (theme === 'dark') {
                    ...
                    colors.push(0, 0, 0); // Need mapping correctly. RGB should be 0-1 range for Float32BufferAttribute typically? Wait!
                }
            }
        }
        ...
        // Map 0-255 to 0-1 for vertex colors in ThreeJS!
        const normalizedColors = colors.map(c => c / 255);
