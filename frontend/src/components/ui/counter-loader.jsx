...
// Exporting as default and named for consistency and ease of use
...
const StyledWrapper = styled.div`
  ...
  /* Added absolute and z-index to act as a proper full screen splash loader */
  position: fixed;
  inset: 0;
  z-index: 9999;
  ...
  #timer > div {
    background-color: #6366f1; /* Matching the theme indigo color instead of skyblue */
    border-radius: 5px;
  }
